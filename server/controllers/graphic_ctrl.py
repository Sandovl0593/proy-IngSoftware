from emotion_log_ctrl import get_emotion_logs, get_emotion_member_codes
...
def get_emotion_area_members_graphic(from_date: str, emotion: str = 'tristeza', area: str = 'Computer Science',
                                     tenant_id: str = 'UTEC'):
